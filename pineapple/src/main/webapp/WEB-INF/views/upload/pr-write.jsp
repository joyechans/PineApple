		            ...
		            <tr>
		             ...
		             <td>
		                    <select name="kind">
		                      ...
		                      <option value="IPHONE">IPHOME</option>
...
<!-- 							    <input type="file" class="custom-file-input" id="customFile" name="attach"> -->
							    <input type="file" id="image" class="custom-file-input" name="attach" onchange="InputImage();"  />
							    <label class="custom-file-label">이미지를 선택해주세요.</label>
							  </div>
